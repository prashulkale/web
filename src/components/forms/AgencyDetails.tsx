...
export default function AgencyDetails({ data }: Props) {
  ...
  const handleSubmit = async (values: z.infer<typeof FormSchema>) => {
    try {
      ...
      console.log("ERROR: ", e)
      toast({ title: "Oppse!", description: "Could not create your agency", variant: "destructive" })
    }
  }
    ...
    if (!data?.id) {
      startDeletingAgency(async () => {
        ...
        try {
          ...
          toast({ title: "Deleted Agency", description: "Deleted your agency and all subaccounts" })
        } catch (e) {
          console.log("ERROR: ", e)
          toast({ title: "Oppse!", description: "Could not delete your agency", variant: "destructive" })
        }
      })
    }
  }
